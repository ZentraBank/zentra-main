...
export default function FundsDonorRegistrationPage() {
  ...
  const [fullName, setFullName] = useState("David Christopher");
  const [nationality, setNationality] = useState("Nigerian");
  const [title, setTitle] = useState("Celebrity Bomber");
      ...
      <div className="relative z-10 mx-auto min-h-screen max-w-[430px] px-3 pb-10 pt-10 md:max-w-[1180px] md:px-10">
        ...
        <section className="mx-auto mt-6 grid max-w-[980px] gap-4 md:mt-10 md:grid-cols-[360px_1fr]">
          <div className="rounded-xl bg-white p-3 text-black/90 md:p-4">
            <h2 className="mb-3 text-[13px] font-black pt-4">
              Editable Donor Profile
            </h2>
          ...
          <div className="flex flex-col rounded-lg bg-white p-2 text-black md:rounded-2xl md:p-5">
            <section className="flex-1 rounded-lg bg-[#a7a7a7] p-2 md:p-4">
              <h2 className="mb-3 text-[14px] font-black">
                  ...
                  {fundingOptions.map((method) => (
                    <button
                      ...
                      className={`h-[28px] rounded-md px-3 text-left text-[12px] transition ${
                        fundingMethods.includes(method)
              ...
              <label className="mt-4 block text-[12px] font-black text-gray-700">
                Transaction date
              </label>
              ...
              <div className="mt-1 grid grid-cols-3 gap-2">
                <select
                  ...
                  className="h-[34px] rounded-lg bg-white px-3 text-[12px] outline-none"
                >
            ...
            <button
              ...
              className="mt-auto self-center flex h-[35px] w-[300px] max-w-full items-center justify-center gap-3 rounded-lg !bg-[#2447d8] text-[14px] font-bold text-white md:h-12 md:w-[360px]"
            >
              <Save size={16} />
              Save Donor
              <ArrowRight size={17} />
