...
// 1. Rename your main function to a child component
  ...
  return (
    <main className="relative min-h-[100svh] overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[430px] flex-col px-4 pb-7 pt-4 md:max-w-[760px] md:px-8 lg:max-w-6xl lg:px-10">
        <Link href="/dashboard" className="absolute left-4 top-4 z-30 text-white">
          <ArrowLeft size={20} />
        </Link>
              ...
              return (
                <Link
                  ...
                  className={`flex h-[18px] items-center justify-center rounded-[6px] text-[11px] font-medium transition ${
                    active ? "bg-blue-700 text-black" : "bg-[#6B7280] text-black"
                  }`}
                >
                  {plan}
                </Link>
...
// 2. Export a default component that wraps the child in a Suspense boundary
