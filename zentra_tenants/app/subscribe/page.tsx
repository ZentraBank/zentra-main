...
function SubscribeContent() {
  ...
  return (
    <AppShell>
      <main className="relative min-h-[calc(100svh-80px)] overflow-hidden bg-black text-white md:flex md:items-center md:justify-center">
        <Image
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100svh-80px)] max-w-[430px] flex-col px-4 pb-7 pt-4 md:min-h-0 md:max-w-[900px] md:rounded-[28px] md:border md:border-white/10 md:bg-black/80 md:p-12 md:shadow-2xl md:backdrop-blur-xl lg:max-w-[1000px]">
