...
export default function DashboardPage() {
  ...
  >
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3 ">
        ...
        <QuickCard title="Open Chat" href="/admin/chat" />
      </div>
...
function QuickCard({ title, href }: { title: string; href: string }) {
  return (
    <Link
      href={href}
      className="flex items-center justify-between rounded-2xl border p-5 shadow-sm hover:shadow-md transition-shadow"
