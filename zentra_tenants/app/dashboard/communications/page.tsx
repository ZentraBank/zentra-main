...
export default function CommunicationsPage() {
  return (
    <AppShell>
      <main className="relative min-h-[calc(100svh-80px)] overflow-x-hidden rounded-3xl bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.16),transparent_18%),radial-gradient(circle_at_bottom_left,rgba(255,255,255,0.13),transparent_16%)] bg-black px-5 pb-14 pt-8 text-white">
        <section className="mx-auto w-full max-w-[1100px]">
          ...
          <div className="mt-7 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            ...
            <Link
              ...
              className="group rounded-[22px] border border-white/10 bg-[#14251D] p-6 text-white shadow-sm transition hover:-translate-y-0.5"
            >
            ...
            <Link
              ...
              className="group rounded-[22px] border border-white/10 bg-[#1D2A44] p-6 text-white shadow-sm transition hover:-translate-y-0.5"
            >
              <div className="flex items-start justify-between">
            ...
            <Link
              ...
              className="group rounded-[22px] border border-white/10 bg-white p-6 text-neutral-900 shadow-sm transition hover:-translate-y-0.5"
            >
              <div className="flex items-start justify-between">
              ...
              <h2 className="mt-7 text-[22px] font-black text-neutral-900">
                Push Notifications
              </h2>

              <p className="mt-2 max-w-[360px] text-[11px] leading-5 text-neutral-500">
